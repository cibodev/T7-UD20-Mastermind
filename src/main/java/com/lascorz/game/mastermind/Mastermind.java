...
public class Mastermind extends JFrame {
	...
	public Mastermind() {
		...
		lblNewLabel.setBounds(585, 11, 116, 14);
		contentPane.add(lblNewLabel);

		JLayeredPane layeredPane = new JLayeredPane();
		layeredPane.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		layeredPane.setForeground(Color.LIGHT_GRAY);
		layeredPane.setBounds(585, 30, 219, 62);
		...
		layeredPane_1.setBounds(585, 144, 219, 62);
		...
		lblColoresSecretos.setBounds(585, 125, 116, 14);
		...
		btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	if(intentos==0) {
            		...
            		if(textField_52.getBackground().equals(Color.black) && textField_53.getBackground().equals(Color.black) && textField_54.getBackground().equals(Color.black) && textField_55.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                	}else {
                		intentos++;
            		...
            		if(textField_56.getBackground().equals(Color.black) && textField_57.getBackground().equals(Color.black) && textField_58.getBackground().equals(Color.black) && textField_59.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                	}else {
                		intentos++;
            		...
            		if(textField_60.getBackground().equals(Color.black) && textField_61.getBackground().equals(Color.black) && textField_62.getBackground().equals(Color.black) && textField_63.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                	}else {
                		intentos++;
            		...
            		if(textField_64.getBackground().equals(Color.black) && textField_65.getBackground().equals(Color.black) && textField_66.getBackground().equals(Color.black) && textField_67.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                	}else{
                		intentos++;
            		...
            		if(textField_68.getBackground().equals(Color.black) && textField_69.getBackground().equals(Color.black) && textField_70.getBackground().equals(Color.black) && textField_71.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                	}else{
                		intentos++;
            		...
            		if(textField_72.getBackground().equals(Color.black) && textField_73.getBackground().equals(Color.black) && textField_74.getBackground().equals(Color.black) && textField_75.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                	}else{
                		intentos++;
            		...
            		if(textField_76.getBackground().equals(Color.black) && textField_77.getBackground().equals(Color.black) && textField_78.getBackground().equals(Color.black) && textField_78.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                	}else{
                		intentos++;
            		...
            		if(textField_80.getBackground().equals(Color.black) && textField_81.getBackground().equals(Color.black) && textField_82.getBackground().equals(Color.black) && textField_83.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                	}else{
                		intentos++;
